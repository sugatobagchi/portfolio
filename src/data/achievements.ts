export const achievements = [
  "Innerve 7.0: <strong>2nd runners-up</strong> (main track) and <strong>1st prize</strong> (5ireChain track) out of <strong>550+ teams</strong>.",
  "HackNITR 4.0: <strong>1st prize</strong> in the Solana track, finalist among <strong>330+ teams</strong>.",
